...
public class ifrm_GestionProveedores extends JInternalFrame {
	...
	public ifrm_GestionProveedores() {
		...
		tblProveedores.getColumnModel().getColumn(2).setPreferredWidth(20);
		mostrarTabla();
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(filaSeleccionada >= 0) {
					try {
						...
						int confirmacion = JOptionPane.showConfirmDialog(ifrm_GestionProveedores.this, "¿Estás seguro de deshabilitar este Proveedor?", "Confirmar Inhabilitacion", JOptionPane.YES_NO_OPTION);
