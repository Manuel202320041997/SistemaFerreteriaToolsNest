			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(filaSeleccionada >= 0) {
					try {
						...
						int confirmacion = JOptionPane.showConfirmDialog(ifrm_GestionarUsuario.this, "¿Estás seguro de deshabilitar este Usuario?", "Confirmar Inhabilitacion", JOptionPane.YES_NO_OPTION);
